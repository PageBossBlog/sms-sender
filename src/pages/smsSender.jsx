...
const SMSSender = () => {
  ...
  const addNewSMTP = (event) => {
    ...
    const { host, port, email, password, security } = formData;

    // Validate input fields
    if (!host || !port || !email || !password || !security) {
  ...
  const download = () => {
    const url = "https://mega.nz/file/VqNW3LjQ#coKOfqOvmV43MuOg2BpTCy4U9dE86nwadxGxlqX6QEo";
  ...
  const sendSMS = async (e) => {
    ...
    if (!smsMessage) {
      toast.error("You need to add an SMS");
      return;
    }

    try {
      const toastId = toast.loading(
        `Sending sms to ${numberCount.toLocaleString()} numbers...`
      );
      ...
      if (
        ...
        toast.error("Phone numbers in your leads are inactive.", {
          duration: 90000,
        });
      }
  ...
  useEffect(() => {
    ...
    if (
      ...
      JSON.stringify(prevSMSResponse.current)
    ) {
      ...
      <div className="w-full">
        ...
        <div className="-mt-2 lg:-mt-2">
          <div className="inline-flex mb-10 text-2xl text-gray-900 font-regular">
            ...
            <span>How to use SMS Sender</span>
          </div>
              ...
              <div className="pl-3">
                ...
                <div className="font-normal text-gray-500">
                  <span className="text-sm">
                    Input one or more SMTPs (Max. 10).
                  </span>
                </div>
              </div>
            </div>
                        ...
                        <div id="accordion-flush">
                          ...
                          <div>
                            ...
                            >
                              ...
                              >
                                [{numberCount.toLocaleString()} numbers uploaded]
                              </p>
                              <svg
                            ...
                            <div className="w-full mb-4 border border-gray-300 rounded-lg bg-gray-50">
                              ...
                              <div className="px-4 py-2 bg-white rounded-b-lg">
                                ...
                                <textarea
                                  ...
                                  required
                                ></textarea>
                                {errorTextAreaMessage && <p className="items-end mt-1 text-sm text-end" style={{ color: 'red' }}>{errorTextAreaMessage}</p>}
                              </div>
                            </div>
                            <button
                              type="button"
                              onClick={sendSMS}
                              className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-900 hover:bg-blue-800"
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
